...
const SKILL_CATEGORIES: Record<string, SkillCategory> = {
  ...
  'binance-spot': 'DeFi & DEX',
  'bybit-spot': 'DeFi & DEX',
  'mexc-spot': 'DeFi & DEX',
  'trading-spot': 'DeFi & DEX',
...
const SKILL_RELATIONS: Record<string, string[]> = {
  ...
  'binance-futures': ['bybit-futures', 'mexc-futures', 'hyperliquid', 'trading-futures', 'binance-spot'],
  'bybit-futures': ['binance-futures', 'mexc-futures', 'hyperliquid', 'bybit-spot'],
  'mexc-futures': ['binance-futures', 'bybit-futures', 'hyperliquid', 'mexc-spot'],
  'binance-spot': ['bybit-spot', 'mexc-spot', 'trading-spot', 'binance-futures', 'jupiter'],
  'bybit-spot': ['binance-spot', 'mexc-spot', 'trading-spot', 'bybit-futures'],
  'mexc-spot': ['binance-spot', 'bybit-spot', 'trading-spot', 'mexc-futures'],
  'trading-spot': ['binance-spot', 'bybit-spot', 'mexc-spot', 'hyperliquid', 'jupiter'],
